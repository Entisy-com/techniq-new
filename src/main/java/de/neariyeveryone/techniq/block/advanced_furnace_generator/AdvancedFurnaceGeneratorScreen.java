...
public class AdvancedFurnaceGeneratorScreen extends AbstractContainerScreen<AdvancedFurnaceGeneratorMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(TechniqConstants.MOD_ID, "textures/gui/furnace_generator.png");
    private EnergyInfoArea energyInfoArea;

    public AdvancedFurnaceGeneratorScreen(AdvancedFurnaceGeneratorMenu menu, Inventory inv, Component component) {
    ...
    private void renderProgressArrow(PoseStack stack, int x, int y) {
        ...
        blit(stack, x + 107, y + 38, 176, 0, menu.getScaledProgress(), 13);
    }
