...
public class BasicFurnaceGeneratorScreen extends AbstractContainerScreen<BasicFurnaceGeneratorMenu> {
    ...
    public BasicFurnaceGeneratorScreen(BasicFurnaceGeneratorMenu menu, Inventory inv, Component component) {
