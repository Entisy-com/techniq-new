...
public class MetalPressScreen extends AbstractContainerScreen<MetalPressMenu> {
    ...
    public MetalPressScreen(MetalPressMenu menu, Inventory inv, Component component) {
...
//        blit(stack, x + 73, y + 38, 182, 5, menu.getScaledProgress(), 21); // arrow
//        blit(stack, x + 67, y + 33, 176, 0, 6, menu.getScaledProgress()); // top connector
//        blit(stack, x + 67, y + 50, 176, 17, 6, -menu.getScaledProgress()); // bottom connector
    }
